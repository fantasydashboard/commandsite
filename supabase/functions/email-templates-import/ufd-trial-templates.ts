// api/admin/trial-email-templates.js
// Auto-extracted from AdminView.vue trial email series.
// HTML content for each trial drip email, sent by send-trial-emails.js.

export const TRIAL_EMAILS = {
  trial_welcome: {
    subject: "Welcome to Ultimate Fantasy Dashboard \u2014 here's how to get started \\u{1F44B}",
    preview: "Connect your league, explore your dashboards, and drop your first graphic in the chat.",
  ...
  trial_power_rankings: {
    subject: "Your power rankings are ready \u2014 here's how to read them \ud83c\udfc6",
    preview: "Who's actually winning your league? It's not always who you think.",
...
<hr style="border:none;border-top:1px solid #1e2130;margin:22px 0;"><p style="font-size:13px;color:#6b7280;font-style:italic;margin:0 0 24px;">You have full access right now during your free trial. Power Rankings update every week automatically.</p><div style="text-align:center;margin:0 0 8px;"><a href="https://ultimatefantasydashboard.com" style="display:inline-block;background:#22c55e;color:#0a0c14;font-size:14px;font-weight:800;letter-spacing:0.05em;padding:14px 36px;border-radius:10px;text-decoration:none;">VIEW MY POWER RANKINGS →</a></div><p style="font-size:11px;color:#374151;text-align:center;margin:0;">ESPN · Yahoo · Sleeper · All leagues supported</p></td></tr><tr><td style="background:#080a10;padding:14px 28px;border-top:1px solid #1e2130;text-align:center;font-size:11px;color:#374151;">ultimatefantasydashboard.com &nbsp;&middot;&nbsp; <a href="{{{RESEND_UNSUBSCRIBE_URL}}}" style="color:#374151;text-decoration:none;">Unsubscribe</a></td></tr></table></td></tr></table></body></html>`,
  ...
  trial_matchups: {
    subject: "Your matchup is live \u2014 here's what's actually happening \u26a1",
    preview: "Real-time win probability. Daily comebacks. A week's worth of trash talk ammunition.",
    html: `<!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"></head><body style="margin:0;padding:0;background:#05060a;font-family:Helvetica Neue,Helvetica,Arial,sans-serif;"><table width="100%" cellpadding="0" cellspacing="0" style="background:#05060a;"><tr><td align="center" style="padding:24px 16px;"><table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#0a0c14;border:1px solid #1e2130;border-radius:12px;overflow:hidden;"><tr><td style="background:#080a10;padding:9px 28px;border-bottom:1px solid #1e2130;text-align:center;font-size:11px;color:#6b7280;line-height:1.5;">&#x1F4C5; <strong style="color:#9ca3af;font-weight:700;">Free trial only:</strong> we&#x2019;re sending you daily emails this week to show off everything UFD can do. After your trial ends, you&#x2019;ll only hear from us when there&#x2019;s something worth saying.</td></tr>
...
<tr><td style="background:#080a10;padding:14px 28px;border-top:1px solid #1e2130;text-align:center;font-size:11px;color:#374151;">ultimatefantasydashboard.com &nbsp;&middot;&nbsp; <a href="{{{RESEND_UNSUBSCRIBE_URL}}}" style="color:#374151;text-decoration:none;">Unsubscribe</a></td></tr>
  ...
  trial_league_history: {
    subject: "Every win. Every rivalry. The full history of your league is here \ud83d\udcdc",
    preview: "Career records, all-time awards, and who actually has your number in head-to-head.",
...
<hr style="border:none;border-top:1px solid #1e2130;margin:22px 0;"><p style="font-size:13px;color:#6b7280;font-style:italic;margin:0 0 24px;">Every win, every rivalry, every title &#x2014; the receipts are all waiting on UFD.</p><div style="text-align:center;margin:0 0 8px;"><a href="https://ultimatefantasydashboard.com" style="display:inline-block;background:#22c55e;color:#0a0c14;font-size:14px;font-weight:800;letter-spacing:0.05em;padding:14px 36px;border-radius:10px;text-decoration:none;">SEE MY LEAGUE HISTORY &#x2192;</a></div><p style="font-size:11px;color:#374151;text-align:center;margin:0;">ESPN &middot; Yahoo &middot; Sleeper &middot; All leagues supported</p></td></tr><!-- FOOTER --><tr><td style="background:#080a10;padding:14px 28px;border-top:1px solid #1e2130;text-align:center;font-size:11px;color:#374151;">ultimatefantasydashboard.com &nbsp;&middot;&nbsp; <a href="{{{RESEND_UNSUBSCRIBE_URL}}}" style="color:#374151;text-decoration:none;">Unsubscribe</a></td></tr></table></td></tr></table></body></html>`,
  ...
  trial_draft_tools: {
    subject: "Your draft just got graded \u2014 pick by pick \ud83d\udccb",
    preview: "Team grades, pick verdicts, steals & busts. Did you actually win the draft?",
...
<tr><td style="background:#080a10;padding:14px 28px;border-top:1px solid #1e2130;text-align:center;font-size:11px;color:#374151;">ultimatefantasydashboard.com &nbsp;&middot;&nbsp; <a href="{{{RESEND_UNSUBSCRIBE_URL}}}" style="color:#374151;text-decoration:none;">Unsubscribe</a></td></tr>
  ...
  trial_ending: {
    subject: "Your free trial ends in 2 days \u2014 here's everything you'd lose \ud83d\udcca",
    preview: "Power rankings, win probability, draft grades, league history \u2014 all going dark.",
    html: `<!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"></head><body style="margin:0;padding:0;background:#05060a;font-family:Helvetica Neue,Helvetica,Arial,sans-serif;"><table width="100%" cellpadding="0" cellspacing="0" style="background:#05060a;"><tr><td align="center" style="padding:24px 16px;"><table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#0a0c14;border:1px solid #1e2130;border-radius:12px;overflow:hidden;">
<!-- TRIAL NOTICE -->
...
<tr><td style="background:#080a10;padding:14px 28px;border-top:1px solid #1e2130;text-align:center;font-size:11px;color:#374151;">ultimatefantasydashboard.com &nbsp;&middot;&nbsp; <a href="{{{RESEND_UNSUBSCRIBE_URL}}}" style="color:#374151;text-decoration:none;">Unsubscribe</a></td></tr>
  ...
  trial_expired: {
    subject: "Your trial ended \u2014 but your league data is still here \u23f8\ufe0f",
    preview: "Everything we built for your league is saved. Pick up where you left off.",
    html: `<!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"></head><body style="margin:0;padding:0;background:#05060a;font-family:Helvetica Neue,Helvetica,Arial,sans-serif;"><table width="100%" cellpadding="0" cellspacing="0" style="background:#05060a;"><tr><td align="center" style="padding:24px 16px;"><table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#0a0c14;border:1px solid #1e2130;border-radius:12px;overflow:hidden;">
<!-- HEADER -->
<tr><td style="background:#0a0c14;border-bottom:2px solid #22c55e;padding:16px 28px;text-align:center;"><img src="https://ultimatefantasydashboard.com/UFD_V8.png" height="26" alt="Ultimate Fantasy Dashboard" style="display:inline-block;"></td></tr>
<!-- BANNER -->
...
<tr><td style="background:#080a10;padding:14px 28px;border-top:1px solid #1e2130;text-align:center;font-size:11px;color:#374151;">ultimatefantasydashboard.com &nbsp;&middot;&nbsp; <a href="{{{RESEND_UNSUBSCRIBE_URL}}}" style="color:#374151;text-decoration:none;">Unsubscribe</a></td></tr>
  ...
  // email_sequence_steps. Cadence: weekly while at-risk, then monthly once
  // they roll into the expired cohort.

  expired_league_recap: {
    subject: "Your league has been busy without you \u26be",
    preview: "Power rankings shifted, win probabilities updated, draft grades sharpened \u2014 here's what UFD has been quietly tracking.",
    html: `<!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"></head><body style="margin:0;padding:0;background:#05060a;font-family:Helvetica Neue,Helvetica,Arial,sans-serif;"><table width="100%" cellpadding="0" cellspacing="0" style="background:#05060a;"><tr><td align="center" style="padding:24px 16px;"><table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#0a0c14;border:1px solid #1e2130;border-radius:12px;overflow:hidden;">
<!-- HEADER -->
<tr><td style="background:#0a0c14;border-bottom:2px solid #22c55e;padding:16px 28px;text-align:center;"><img src="https://ultimatefantasydashboard.com/UFD_V8.png" height="26" alt="Ultimate Fantasy Dashboard" style="display:inline-block;"></td></tr>
<!-- BANNER -->
<tr><td style="background:linear-gradient(90deg,#0a1f0f,#0c1824);border-bottom:1px solid rgba(34,197,94,0.2);padding:11px 28px;text-align:center;font-size:12px;color:#86efac;letter-spacing:0.03em;">&#x1F4CA; Two weeks since your trial &#x2014; your league has been moving</td></tr>
<!-- BODY -->
<tr><td style="padding:36px 32px 28px;background:#0a0c14;">
<p style="font-size:11px;font-weight:700;letter-spacing:0.18em;text-transform:uppercase;color:#22c55e;margin:0 0 10px;">QUIET PROGRESS</p>
<h1 style="font-size:27px;font-weight:900;color:#fff;line-height:1.1;letter-spacing:-0.02em;margin:0 0 18px;">Two more weeks. A lot has changed.</h1>
<p style="font-size:14px;color:#9ca3af;line-height:1.75;margin:0 0 16px;">It&#x2019;s been about two weeks since your trial ended. Your league has played more matchups, scores have settled, and the early-season noise is starting to look like real signal. <strong style="color:#e5e7eb;">UFD has been tracking all of it &#x2014; you just can&#x2019;t see it right now.</strong></p>
<p style="font-size:14px;color:#9ca3af;line-height:1.75;margin:0 0 20px;">No pitch today. Just a quick recap of what UFD picks up in the weeks after a trial ends &#x2014; the moments that tend to shift the season.</p>

<table width="100%" cellpadding="0" cellspacing="0" style="background:#11131a;border:1px solid #1e2130;border-radius:12px;overflow:hidden;margin:0 0 22px;">
<tr><td style="background:#080a10;padding:10px 16px;border-bottom:1px solid #1e2130;"><div style="font-size:11px;font-weight:700;color:#4b5563;letter-spacing:0.1em;text-transform:uppercase;">&#x1F4CA; What UFD has been tracking</div></td></tr>
<tr><td style="padding:14px 16px;">
<table width="100%" cellpadding="0" cellspacing="0">
<tr><td style="padding:8px 0;border-bottom:1px solid #0f1017;"><table width="100%" cellpadding="0" cellspacing="0"><tr>
<td width="34" style="font-size:18px;text-align:center;">&#x1F3C6;</td>
<td style="padding-left:10px;"><div style="font-size:13px;font-weight:700;color:#e5e7eb;">Power Rankings have shifted</div><div style="font-size:11px;color:#6b7280;line-height:1.5;">The biggest re-orderings happen in weeks 2&#x2013;4 once point totals stabilize. Your league&#x2019;s real top team probably isn&#x2019;t who you&#x2019;d guess.</div></td>
</tr></table></td></tr>
<tr><td style="padding:8px 0;border-bottom:1px solid #0f1017;"><table width="100%" cellpadding="0" cellspacing="0"><tr>
<td width="34" style="font-size:18px;text-align:center;">&#x26A1;</td>
<td style="padding-left:10px;"><div style="font-size:13px;font-weight:700;color:#e5e7eb;">Win Probability ran every day</div><div style="font-size:11px;color:#6b7280;line-height:1.5;">Monte Carlo odds for every matchup, recalculated daily. The team you thought was a lock might be a coin flip by Sunday.</div></td>
</tr></table></td></tr>
<tr><td style="padding:8px 0;border-bottom:1px solid #0f1017;"><table width="100%" cellpadding="0" cellspacing="0"><tr>
<td width="34" style="font-size:18px;text-align:center;">&#x1F4CB;</td>
<td style="padding-left:10px;"><div style="font-size:13px;font-weight:700;color:#e5e7eb;">Draft Grades got sharper</div><div style="font-size:11px;color:#6b7280;line-height:1.5;">Two more weeks of real performance means draft picks have been re-graded against actual production. Steals and busts are clearer now.</div></td>
</tr></table></td></tr>
<tr><td style="padding:8px 0;"><table width="100%" cellpadding="0" cellspacing="0"><tr>
<td width="34" style="font-size:18px;text-align:center;">&#x1F4DC;</td>
<td style="padding-left:10px;"><div style="font-size:13px;font-weight:700;color:#e5e7eb;">League History grew</div><div style="font-size:11px;color:#6b7280;line-height:1.5;">Every matchup adds to the all-time records, H2H matrix, and tale-of-the-tape. The receipts keep growing whether you&#x2019;re watching or not.</div></td>
</tr></table></td></tr>
</table>
</td></tr>
</table>
...
<hr style="border:none;border-top:1px solid #1e2130;margin:22px 0;">
<p style="font-size:13px;color:#6b7280;font-style:italic;margin:0 0 24px;">Your league connection is still active. Nothing to set up again &#x2014; everything is right where you left it.</p>
<div style="text-align:center;margin:0 0 8px;"><a href="https://ultimatefantasydashboard.com" style="display:inline-block;background:#22c55e;color:#0a0c14;font-size:14px;font-weight:800;letter-spacing:0.05em;padding:14px 36px;border-radius:10px;text-decoration:none;">SEE WHAT&#x2019;S CHANGED &#x2192;</a></div>
<p style="font-size:11px;color:#374151;text-align:center;margin:0;">No charge to look around &middot; Pricing only when you&#x2019;re ready</p>
</td></tr>
<!-- FOOTER -->
<tr><td style="background:#080a10;padding:14px 28px;border-top:1px solid #1e2130;text-align:center;font-size:11px;color:#374151;">ultimatefantasydashboard.com &nbsp;&middot;&nbsp; <a href="{{{RESEND_UNSUBSCRIBE_URL}}}" style="color:#374151;text-decoration:none;">Unsubscribe</a></td></tr>
</table></td></tr></table></body></html>`,
  ...
  expired_feature_spotlight: {
    subject: "Three questions UFD answered for you (and now doesn't) \ud83d\udd0d",
    preview: "Who's actually winning, what are my odds, how did I draft \u2014 quick refresher on what your dashboard used to surface.",
    html: `<!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"></head><body style="margin:0;padding:0;background:#05060a;font-family:Helvetica Neue,Helvetica,Arial,sans-serif;"><table width="100%" cellpadding="0" cellspacing="0" style="background:#05060a;"><tr><td align="center" style="padding:24px 16px;"><table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#0a0c14;border:1px solid #1e2130;border-radius:12px;overflow:hidden;">
<!-- HEADER -->
<tr><td style="background:#0a0c14;border-bottom:2px solid #06b6d4;padding:16px 28px;text-align:center;"><img src="https://ultimatefantasydashboard.com/UFD_V8.png" height="26" alt="Ultimate Fantasy Dashboard" style="display:inline-block;"></td></tr>
<!-- BANNER -->
<tr><td style="background:linear-gradient(90deg,#0a1828,#0c1f2e);border-bottom:1px solid rgba(6,182,212,0.2);padding:11px 28px;text-align:center;font-size:12px;color:#67e8f9;letter-spacing:0.03em;">&#x1F50D; Three things you used to be able to answer</td></tr>
<!-- BODY -->
<tr><td style="padding:36px 32px 28px;background:#0a0c14;">
<p style="font-size:11px;font-weight:700;letter-spacing:0.18em;text-transform:uppercase;color:#06b6d4;margin:0 0 10px;">FEATURE SPOTLIGHT</p>
<h1 style="font-size:27px;font-weight:900;color:#fff;line-height:1.1;letter-spacing:-0.02em;margin:0 0 18px;">When you had UFD, you could answer questions like these.</h1>
<p style="font-size:14px;color:#9ca3af;line-height:1.75;margin:0 0 24px;">A quick refresher on what your dashboard used to surface every week. No data here today &#x2014; just the questions UFD is built to answer the moment you&#x2019;re back.</p>

<!-- Q1 \u2014 Power Rankings -->
<table width="100%" cellpadding="0" cellspacing="0" style="background:#11131a;border:1px solid #1e2130;border-radius:12px;overflow:hidden;margin:0 0 14px;">
<tr><td style="padding:18px 18px 16px;">
<div style="font-size:11px;font-weight:800;color:#22c55e;letter-spacing:0.06em;text-transform:uppercase;margin-bottom:6px;">&#x1F3C6; Question 1</div>
<div style="font-size:18px;font-weight:800;color:#fff;line-height:1.3;margin-bottom:10px;">Who&#x2019;s actually the best team in my league right now?</div>
<div style="font-size:13px;color:#9ca3af;line-height:1.7;margin-bottom:8px;">Standings answer one thing: who got lucky with their schedule. <strong style="color:#e5e7eb;">Power Rankings</strong> combine record, total points, all-play, recent form, and consistency into one score that tells the real story &#x2014; updated every week, with movement arrows and a trend graph going back to week 1.</div>
<div style="font-size:11px;color:#6b7280;font-style:italic;">Lives in: Rankings tab</div>
</td></tr>
</table>
...
<table width="100%" cellpadding="0" cellspacing="0" style="background:#11131a;border:1px solid #1e2130;border-radius:12px;overflow:hidden;margin:0 0 14px;">
<tr><td style="padding:18px 18px 16px;">
<div style="font-size:11px;font-weight:800;color:#eab308;letter-spacing:0.06em;text-transform:uppercase;margin-bottom:6px;">&#x26A1; Question 2</div>
<div style="font-size:18px;font-weight:800;color:#fff;line-height:1.3;margin-bottom:10px;">What are my real odds this week?</div>
<div style="font-size:13px;color:#9ca3af;line-height:1.7;margin-bottom:8px;">UFD runs <strong style="color:#e5e7eb;">10,000 Monte Carlo simulations every day</strong> against your current matchup, accounting for projections, injuries, and the rest of your league&#x2019;s schedule. The number you see on the dashboard is the actual probability &#x2014; not a vibe.</div>
<div style="font-size:11px;color:#6b7280;font-style:italic;">Lives in: Matchups tab</div>
</td></tr>
</table>
...
<table width="100%" cellpadding="0" cellspacing="0" style="background:#11131a;border:1px solid #1e2130;border-radius:12px;overflow:hidden;margin:0 0 22px;">
<tr><td style="padding:18px 18px 16px;">
<div style="font-size:11px;font-weight:800;color:#06b6d4;letter-spacing:0.06em;text-transform:uppercase;margin-bottom:6px;">&#x1F4CB; Question 3</div>
<div style="font-size:18px;font-weight:800;color:#fff;line-height:1.3;margin-bottom:10px;">How good was my draft, actually?</div>
<div style="font-size:13px;color:#9ca3af;line-height:1.7;margin-bottom:8px;">Every pick is graded against where players have actually finished &#x2014; not where they were projected. <strong style="color:#e5e7eb;">Team grades, individual steals, busts, and the verdict on every round.</strong> The grades sharpen as the season unfolds.</div>
<div style="font-size:11px;color:#6b7280;font-style:italic;">Lives in: Draft tab</div>
</td></tr>
</table>

<hr style="border:none;border-top:1px solid #1e2130;margin:22px 0;">
<p style="font-size:13px;color:#6b7280;font-style:italic;margin:0 0 24px;">Three weeks since your trial. Your league connection is still live &#x2014; the answers are waiting on the other side of unlock.</p>
<div style="text-align:center;margin:0 0 8px;"><a href="https://ultimatefantasydashboard.com/pricing" style="display:inline-block;background:#06b6d4;color:#0a0c14;font-size:14px;font-weight:800;letter-spacing:0.05em;padding:14px 36px;border-radius:10px;text-decoration:none;">UNLOCK MY LEAGUE &#x2192;</a></div>
<p style="font-size:11px;color:#374151;text-align:center;margin:0;">Individual $4/mo &middot; League Pass $29 &middot; Cancel anytime</p>
</td></tr>
<!-- FOOTER -->
<tr><td style="background:#080a10;padding:14px 28px;border-top:1px solid #1e2130;text-align:center;font-size:11px;color:#374151;">ultimatefantasydashboard.com &nbsp;&middot;&nbsp; <a href="{{{RESEND_UNSUBSCRIBE_URL}}}" style="color:#374151;text-decoration:none;">Unsubscribe</a></td></tr>
  ...
  expired_offer_first: {
    subject: "10% off an annual pass \u2014 7 days only \u23f3",
    preview: "Your first chance at a discount. Code expires in 7 days, one use per customer.",
    html: `<!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"></head><body style="margin:0;padding:0;background:#05060a;font-family:Helvetica Neue,Helvetica,Arial,sans-serif;"><table width="100%" cellpadding="0" cellspacing="0" style="background:#05060a;"><tr><td align="center" style="padding:24px 16px;"><table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#0a0c14;border:1px solid #1e2130;border-radius:12px;overflow:hidden;">
<!-- HEADER -->
<tr><td style="background:#0a0c14;border-bottom:2px solid #f59e0b;padding:16px 28px;text-align:center;"><img src="https://ultimatefantasydashboard.com/UFD_V8.png" height="26" alt="Ultimate Fantasy Dashboard" style="display:inline-block;"></td></tr>
<!-- BANNER -->
<tr><td style="background:linear-gradient(90deg,#1f1505,#2a1d0a);border-bottom:1px solid rgba(245,158,11,0.25);padding:11px 28px;text-align:center;font-size:12px;color:#fbbf24;letter-spacing:0.03em;">&#x23F3; Limited-time offer &#x2014; 7 days only</td></tr>
<!-- BODY -->
<tr><td style="padding:36px 32px 28px;background:#0a0c14;">
<p style="font-size:11px;font-weight:700;letter-spacing:0.18em;text-transform:uppercase;color:#f59e0b;margin:0 0 10px;">FOR YOU</p>
<h1 style="font-size:27px;font-weight:900;color:#fff;line-height:1.1;letter-spacing:-0.02em;margin:0 0 18px;">10% off an annual individual pass.</h1>
<p style="font-size:14px;color:#9ca3af;line-height:1.75;margin:0 0 22px;">It&#x2019;s been about a month since your trial ended. Time to stop being on the fence &#x2014; here&#x2019;s your nudge. <strong style="color:#e5e7eb;">10% off an annual pass for the next 7 days.</strong> One use per customer.</p>

<!-- OFFER CARD -->
<table width="100%" cellpadding="0" cellspacing="0" style="background:linear-gradient(135deg,rgba(245,158,11,0.08),rgba(34,197,94,0.04));border:1px solid rgba(245,158,11,0.35);border-radius:14px;overflow:hidden;margin:0 0 24px;">
<tr><td style="padding:24px 22px;text-align:center;">
<div style="font-size:11px;font-weight:800;color:#fbbf24;letter-spacing:0.1em;text-transform:uppercase;margin-bottom:8px;">Annual Individual Pass</div>
<div style="font-size:14px;color:#6b7280;text-decoration:line-through;margin-bottom:2px;">$49<span style="font-size:11px;">/year</span></div>
<div style="font-size:36px;font-weight:900;color:#fff;line-height:1;margin-bottom:6px;">$44.10<span style="font-size:14px;font-weight:600;color:#9ca3af;"> /year</span></div>
<div style="font-size:12px;color:#86efac;font-weight:700;margin-bottom:18px;">You save $4.90 on year one</div>
<div style="background:#0a0c14;border:1px dashed #f59e0b;border-radius:10px;padding:12px 14px;margin:0 0 14px;">
<div style="font-size:10px;color:#6b7280;letter-spacing:0.08em;text-transform:uppercase;margin-bottom:4px;">Discount code</div>
<div style="font-size:18px;font-weight:900;color:#fbbf24;letter-spacing:0.16em;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;">COMEBACK10</div>
</div>
<div style="font-size:11px;color:#6b7280;font-style:italic;">Code expires 7 days from today &middot; Annual plan only</div>
</td></tr>
</table>

<!-- WHY ANNUAL -->
<div style="background:rgba(34,197,94,0.06);border:1px solid rgba(34,197,94,0.22);border-radius:10px;padding:14px 16px;margin:0 0 22px;font-size:12px;color:#9ca3af;line-height:1.7;">
<div style="font-size:12px;font-weight:800;color:#86efac;letter-spacing:0.04em;margin-bottom:6px;">&#x1F4A1; Why annual?</div>
A full season is six&#x2013;seven months of fantasy. The annual pass covers it edge-to-edge with one charge &#x2014; no month-to-month decision-making, no &#x201C;is it worth it this week.&#x201D; You just have it.
</div>

<hr style="border:none;border-top:1px solid #1e2130;margin:22px 0;">
<p style="font-size:13px;color:#6b7280;font-style:italic;margin:0 0 24px;">Your league connection is still saved. Apply the code at checkout and you&#x2019;re back in.</p>
<div style="text-align:center;margin:0 0 8px;"><a href="https://ultimatefantasydashboard.com/pricing?promo=COMEBACK10" style="display:inline-block;background:#f59e0b;color:#0a0c14;font-size:14px;font-weight:800;letter-spacing:0.05em;padding:14px 36px;border-radius:10px;text-decoration:none;">CLAIM 10% OFF &#x2192;</a></div>
<p style="font-size:11px;color:#374151;text-align:center;margin:0;">Cancel anytime &middot; All sports, all your leagues</p>
</td></tr>
<!-- FOOTER -->
<tr><td style="background:#080a10;padding:14px 28px;border-top:1px solid #1e2130;text-align:center;font-size:11px;color:#374151;">ultimatefantasydashboard.com &nbsp;&middot;&nbsp; <a href="{{{RESEND_UNSUBSCRIBE_URL}}}" style="color:#374151;text-decoration:none;">Unsubscribe</a></td></tr>
</table></td></tr></table></body></html>`,
  ...
  expired_last_call: {
    subject: "Last call: 10% off expires today (and a quick favor) \ud83d\udc4b",
    preview: "Your discount window closes tonight. If you're not coming back, we'd love to know why.",
    html: `<!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"></head><body style="margin:0;padding:0;background:#05060a;font-family:Helvetica Neue,Helvetica,Arial,sans-serif;"><table width="100%" cellpadding="0" cellspacing="0" style="background:#05060a;"><tr><td align="center" style="padding:24px 16px;"><table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;background:#0a0c14;border:1px solid #1e2130;border-radius:12px;overflow:hidden;">
<!-- HEADER -->
<tr><td style="background:#0a0c14;border-bottom:2px solid #f97316;padding:16px 28px;text-align:center;"><img src="https://ultimatefantasydashboard.com/UFD_V8.png" height="26" alt="Ultimate Fantasy Dashboard" style="display:inline-block;"></td></tr>
<!-- BANNER -->
<tr><td style="background:linear-gradient(90deg,#1f0d05,#2a140a);border-bottom:1px solid rgba(249,115,22,0.3);padding:11px 28px;text-align:center;font-size:12px;color:#fdba74;letter-spacing:0.03em;">&#x1F6A8; Last day &#x2014; your 10% off expires tonight</td></tr>
<!-- BODY -->
<tr><td style="padding:36px 32px 28px;background:#0a0c14;">
<p style="font-size:11px;font-weight:700;letter-spacing:0.18em;text-transform:uppercase;color:#f97316;margin:0 0 10px;">LAST CALL</p>
<h1 style="font-size:27px;font-weight:900;color:#fff;line-height:1.1;letter-spacing:-0.02em;margin:0 0 18px;">Last chance for 10% off &#x2014; and a small favor.</h1>
<p style="font-size:14px;color:#9ca3af;line-height:1.75;margin:0 0 22px;">Your <strong style="color:#fbbf24;">COMEBACK10</strong> discount window closes today. After this, the email cadence drops way down &#x2014; we&#x2019;re not going to keep nudging you. So one last shot, and then a question if you&#x2019;re not coming back.</p>

<!-- TWO PATHS -->
<table width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 24px;">
<!-- Path 1: claim -->
<tr><td style="padding:0 0 12px;">
<table width="100%" cellpadding="0" cellspacing="0" style="background:rgba(249,115,22,0.06);border:1px solid rgba(249,115,22,0.3);border-radius:12px;overflow:hidden;">
<tr><td style="padding:18px 20px;">
<div style="font-size:11px;font-weight:800;color:#fdba74;letter-spacing:0.08em;text-transform:uppercase;margin-bottom:6px;">&#x1F3AF; If you&#x2019;re coming back</div>
<div style="font-size:17px;font-weight:800;color:#fff;line-height:1.3;margin-bottom:8px;">Claim your 10% off before it expires.</div>
<div style="font-size:13px;color:#9ca3af;line-height:1.6;margin-bottom:14px;">Annual individual pass: $49 &rarr; <strong style="color:#fbbf24;">$44.10/year</strong> with code <strong style="color:#fbbf24;font-family:ui-monospace,SFMono-Regular,Menlo,monospace;">COMEBACK10</strong>. League connection is saved.</div>
<div><a href="https://ultimatefantasydashboard.com/pricing?promo=COMEBACK10" style="display:inline-block;background:#f97316;color:#0a0c14;font-size:13px;font-weight:800;letter-spacing:0.05em;padding:11px 24px;border-radius:8px;text-decoration:none;">CLAIM IT &#x2192;</a></div>
</td></tr>
</table>
</td></tr>
<!-- Path 2: tell us why -->
<tr><td>
<table width="100%" cellpadding="0" cellspacing="0" style="background:rgba(99,102,241,0.06);border:1px solid rgba(99,102,241,0.25);border-radius:12px;overflow:hidden;">
<tr><td style="padding:18px 20px;">
<div style="font-size:11px;font-weight:800;color:#a5b4fc;letter-spacing:0.08em;text-transform:uppercase;margin-bottom:6px;">&#x1F4AC; If you&#x2019;re not</div>
<div style="font-size:17px;font-weight:800;color:#fff;line-height:1.3;margin-bottom:8px;">Tell us what would have made it worth it.</div>
<div style="font-size:13px;color:#9ca3af;line-height:1.6;margin-bottom:14px;">No marketing form. Just hit reply and tell us in one sentence: <em>what was missing, what was wrong, or what would have changed your mind?</em> Real answers shape what we build next &#x2014; and the people who reply tend to get the things they ask for.</div>
<div><a href="mailto:support@ultimatefantasydashboard.com?subject=Why%20I%20didn%27t%20continue%20with%20UFD&amp;body=The%20one%20thing%20that%20would%20have%20made%20UFD%20worth%20it%3A%0A%0A" style="display:inline-block;background:#6366f1;color:#fff;font-size:13px;font-weight:800;letter-spacing:0.05em;padding:11px 24px;border-radius:8px;text-decoration:none;">REPLY WITH ONE SENTENCE &#x2192;</a></div>
</td></tr>
</table>
</td></tr>
</table>
...
<hr style="border:none;border-top:1px solid #1e2130;margin:22px 0;">
<p style="font-size:12px;color:#6b7280;font-style:italic;margin:0 0 8px;text-align:center;">After today the cadence drops to monthly &mdash; we&#x2019;ll only check in occasionally with what&#x2019;s new.</p>
</td></tr>
<!-- FOOTER -->
<tr><td style="background:#080a10;padding:14px 28px;border-top:1px solid #1e2130;text-align:center;font-size:11px;color:#374151;">ultimatefantasydashboard.com &nbsp;&middot;&nbsp; <a href="{{{RESEND_UNSUBSCRIBE_URL}}}" style="color:#374151;text-decoration:none;">Unsubscribe</a></td></tr>
</table></td></tr></table></body></html>`,
...
// Lifecycle sequence: trial drip (days 0–5 from trial_started_at) → at-risk
// drip (days 8–35 from trial_expires_at, weekly cadence). Steps with
// useExpiryDate are anchored on the user's trial_expires_at; the rest fire
// off trial_started_at. skipIfPaid means a user who upgrades stops
// receiving the rest of the sequence.
export const TRIAL_SEQUENCE = [
  // ── Trial drip (daily) ────────────────────────────────────────────────
  { id: 'trial_welcome', day: 0 },
  { id: 'trial_power_rankings', day: 1 },
  { id: 'trial_matchups', day: 2 },
  { id: 'trial_league_history', day: 3 },
  ...
  { id: 'expired_last_call', day: 35, skipIfPaid: true, useExpiryDate: true },
]
