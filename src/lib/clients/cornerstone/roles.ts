...
export const graceRoles: GraceRole[] = [
  ...
  },
  {
    ...
    icon: 'qa_assistant',
    name: 'Welcome',
    description: 'First-time follow-up within 24 hours, in your pastor\'s voice.',
    tab: 'front-desk-guests',
    status: 'active',
    this_week_snippet: '8 first-time families · avg open 11 min · 5 day-3 nudges queued',
    this_week_count: 13,
    minutes_saved_per_event: 6,
    business_outcome_headline: '8 welcomes',
    business_outcome_label: 'first-time families this week',
  },
  {
    key: 'stories',
    icon: 'review_engine',
  ...
  },
  {
    ...
    icon: 'alert-triangle',
    name: 'Drift Watch',
    description: 'Households starting to fade, surfaced for pastoral outreach.',
    tab: 'care-drift',
    status: 'active',
    this_week_snippet: 'Sullivan family crossed 2-flag threshold · pastoral check-in drafted',
    this_week_count: 6,
    minutes_saved_per_event: 4,
    business_outcome_headline: '1 household',
    business_outcome_label: 'flagged + check-in drafted',
  },
  {
    key: 'care_triage',
