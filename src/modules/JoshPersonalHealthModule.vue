...
/**
 * Josh Personal — Health (default landing tab).
 *
 * Today-focused: snapshot + today's slice from the active weekly plan.
 * Keeps a compact "active concerns" reminder linking to the Bloodwork
 * tab. The deeper surfaces (Plan grid, Trends charts, full Bloodwork
 * table, Goals) live on their own tabs so this page stays scannable.
 *
 * Eventually the Health tab gets paired with a "Today" tab above it
 * that aggregates across modules (work, relationships, etc.). For
 * now Health IS the daily landing.
 */
...
<template>
  <div class="space-y-5">
      ...
      <div class="flex items-start gap-3 bg-brand/5 px-5 py-3 border-b border-brand/20">
        ...
        <div class="flex-1 min-w-0">
          ...
          <p class="text-xs text-ink-muted leading-relaxed">
            Your daily snapshot + today's slice from this week's plan. Full week is on the Plan tab; longer trends on Trends.
          </p>
        </div>
      </div>
    ...
    <!-- ── Today's plan slice (workout + meals) ────────────────────── -->
    ...
    <!-- ── Active concerns reminder (compact, links to Bloodwork tab) ─ -->
