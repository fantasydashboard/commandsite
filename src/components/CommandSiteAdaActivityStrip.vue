...
/**
 * CommandSite — per-page Ada activity strip.
 * Same shape as ApexAdaActivityStrip + CornerstoneGraceActivityStrip,
 * but reads from CommandSite's own (solo-founder) Ada role inventory.
 */
